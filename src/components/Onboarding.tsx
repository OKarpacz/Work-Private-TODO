...
const slides = [
  {
    ...
    description:
      'Zarządzaj wszystkimi zadaniami w jednym miejscu - prywatne, służbowe i domowe.',
  },
  {
    icon: User,
    color: '#3B82F6',
  ...
  },
  {
    ...
    title: 'Work',
    description:
      'Projekty zawodowe, spotkania i współpraca z zespołem. Wszystko pod kontrolą.',
  },
  {
    icon: Home,
    color: '#10B981',
    title: 'Home',
    description:
      'Zadania rodzinne i domowe. Dziel się z bliskimi i organizuj wspólne życie.',
  },
  {
    icon: Clock,
    color: '#EC4899',
    ...
    description:
      'Automatycznie ukrywaj zadania służbowe po godzinach pracy. Dbaj o równowagę.',
  },
] as const;
          ...
          {slides.map((_, index) => (
            <div
              ...
              style={{
                ...
                backgroundColor:
                  currentSlide === index ? slide.color : '#E5E7EB',
              }}
            />
          ))}
        </div>
